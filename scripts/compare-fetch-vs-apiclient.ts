...
async function runComparison() {
  ...
  console.log("=".repeat(70));
  console.log("\n");
  console.log("fetch nativo:              ", results.nativeFetch ? "✅ OK" : "❌ FAIL");
  console.log("ApiClient (básico):        ", results.apiClientBasic ? "✅ OK" : "❌ FAIL");
  console.log("ApiClient (con logger):    ", results.apiClientLogger ? "✅ OK" : "❌ FAIL");
  console.log("ApiClient (body en opts):  ", results.apiClientOptions ? "✅ OK" : "❌ FAIL");

  console.log("\n");
  if (!results.apiClientBasic && results.nativeFetch) {
    console.log("🔍 DIAGNÓSTICO:");
    console.log("fetch funciona pero ApiClient falla → hay un bug en bytekit");
    console.log("\nPosibles causas:");
