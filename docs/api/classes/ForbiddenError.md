...
[bytekit](../globals.md) / ForbiddenError

# Class: ForbiddenError

Defined in: core/ErrorBoundary.ts:61
...
> **new ForbiddenError**(`message`, `context?`): `ForbiddenError`

Defined in: core/ErrorBoundary.ts:62
