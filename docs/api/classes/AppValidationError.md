...
[bytekit](../globals.md) / AppValidationError

# Class: AppValidationError

Defined in: core/ErrorBoundary.ts:40
...
> **new AppValidationError**(`message`, `context?`): `AppValidationError`

Defined in: core/ErrorBoundary.ts:41
